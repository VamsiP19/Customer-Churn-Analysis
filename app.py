...
df_1=pd.read_csv("/Users/vamshi/Desktop/churn/first_telc.csv")

q = ""

@app.route("/")
def loadPage():
	return render_template('/Users/vamshi/Desktop/churn/home.html', query="")
...
def predict():
    ...
    model = joblib.load(open("/Users/vamshi/Desktop/churn/model.sav"))
    ...
    return render_template('/Users/vamshi/Desktop/churn/home.html', output1=o1, output2=o2, 
